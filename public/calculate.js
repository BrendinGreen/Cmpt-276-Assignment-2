...
function calculateValues(){
    ...
    for (var i = 0; i < sections; i++){
        thresholds[i] = parseFloat(document.getElementById("threshold"+i).value);
    }
    ...
    // Set DOM objects
    for (var k = 0; k < numberOfStudents.length; k++){

        document.getElementById("result" + k + "progress").value = (errorFlag) ? 0 : numberOfStudents[k];
        document.getElementById("result" + k + "progress").max = "" + numberOfStudents.reduce(function (p1, p2) { return Math.max(p1, p2) }) ;
    }
